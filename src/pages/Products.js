...
const data = [
  ...
  {
    id: 7,
    name: "JBL Tune 510BT: Wireless Headphones with Purebass Sound - White",
    description:
  ...
  {
    id: 8,
    name: "Bluetooth Headphones Earbuds 36Hrs Playtime Wireless Charging",
    description:
  ...
  {
    id: 10,
    name: "Military Smart Watch for Men Waterproof Tactical Smartwatch",
    description:
...
const Products = () => {
  return (
    <div className="products-section container mx-auto py-10">
      ...
      <div className="products-wrapper grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-10">
        {data.map((product) => (
